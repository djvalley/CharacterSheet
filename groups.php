...
<div class="wrapper">
   ...
   foreach ($data AS $row) {
//       echo "$row[characterName] $row[accountType] <br>";
       echo <<<CHARBLOCK
<h1>$row[characterName]<button>Edit</button><input type="submit" name="updateChar" value="Save"> </h1>
<form action="characterUpdate.php" method="post">
<div class="mainStats">
<table class="character stats">
  <tr>
    <th colspan="2"><h3>$row[accountType]</h3></th>
  </tr>
  <tr>
    <th>CharacterID</th>
